...
{
    [DefOf]
    public static class SaleOfGoodsDefOf
    {
        public static DutyDef SaleOfGoods_StripDuelEquipment;
        public static JobDef SaleOfGoods_StripEquipment;
    }
    ...
    public static class NUPUtility
    {
        ...
        public static void DropThings(Pawn pawn, bool keepInventoryAndEquipmentIfInBed, bool IsAKill, bool rememberPrimary)
        {
            ...
            if (pawn.equipment != null
                && (pawn.IsColonistPlayerControlled && (IsAKill && !SaleOfGoodsSettings.drops || !IsAKill && !SaleOfGoodsSettings.drops)
                || !pawn.IsColonistPlayerControlled && (IsAKill && !(SaleOfGoodsSettings.drops) || !IsAKill && (!SaleOfGoodsSettings.drops))))
            {
